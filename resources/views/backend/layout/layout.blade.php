...
<div class="wrapper">
    <header class="main-header">
        <!-- Logo -->
        <a href="{!! url('/admin') !!}" class="logo"><b>USPORT</b> Admin</a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">{{ (Auth::user()->name == 'NULL')?Auth::user()->email:Auth::user()->name }}</span> </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                <p> {{ (Auth::user()->name == 'NULL')?Auth::user()->email:Auth::user()->name }}
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="{{ url('/logout') }}" class="btn btn-default btn-flat">Sign out</a></div>
