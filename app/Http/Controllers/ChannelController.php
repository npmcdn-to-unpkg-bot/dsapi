...
class ChannelController extends Controller
{
     ...
     */
    public function getmatch($source = '') {
    	$source = ($source == '') ? 'http://www.8bongda.com/xem-bong-da-truc-tuyen/link-sopcast/' : $source;
	...
	protected function str_get_html($str, $lowercase=true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
	{
		$dom = new simple_html_dom(null, $lowercase, $forceTagsClosed, $target_charset, $stripRN, $defaultBRText, $defaultSpanText);
	...
	// dump html dom tree
	protected function dump_html_tree($node, $show_attr=true, $deep=0)
	{
		$node->dump($node);
	}
}
